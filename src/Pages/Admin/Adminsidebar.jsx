    ...
    return (
        ...
        <div>
            <button
                ...
                className="absolute z-100 -mt-7 left-50 inline-flex cursor-pointer items-center p-2 text-sm text-black rounded-lg sm:hidden focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
            >
                <svg
                    className="w-6 h-6"
                    aria-hidden="true"
            ...
            <aside
                id="default-sidebar"
                className={`bg-gray-500 absolute -z-10 fixed top-0 left-0 z-40 w-64 h-screen transition-transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'
                    } sm:translate-x-0`} // Conditional class for sliding the sidebar
                aria-label="Sidebar">
                <div class="h-full px-3 py-4 overflow-y-auto bg-dark-50 dark:bg-gray-800">
                    <ul class="space-y-2 font-medium mt-16">
                        <li>
                            <a href="#" class="flex items-center p-2 rounded-lg hover:bg-gray-600  dark:hover:bg-gray-700 group">
                                <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                                    <path d="M16.975 11H10V4.025a1 1 0 0 0-1.066-.998 8.5 8.5 0 1 0 9.039 9.039.999.999 0 0 0-1-1.066h.002Z" />
                                    <path d="M12.5 0c-.157 0-.311.01-.565.027A1 1 0 0 0 11 1.02V10h8.975a1 1 0 0 0 1-.935c.013-.188.028-.374.028-.565A8.51 8.51 0 0 0 12.5 0Z" />
                                </svg>
                                <Link to={'/Admindashboardpage'}>
                                    <span class="flex-1 ms-3 whitespace-nowrap w-full text-white">Dashboard</span>
                                </Link>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-600 dark:hover:bg-gray-700 group">
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap text-white">Category</span>
                        ...
                        <li>
                            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-600 dark:hover:bg-gray-700 group">
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap text-white">Sign In</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-600 dark:hover:bg-gray-700 group">
